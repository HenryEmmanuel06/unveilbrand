    ...
    <section className="w-full flex flex-col items-center justify-center pt-45 pb-20">
      <AnimatedSection className="w-[90%] lg:w-full max-w-[1332px] mx-auto">
        ...
        <div className="w-[90%] max-w-[1332px] mx-auto flex md:flex-row flex-col items-stretch justify-center mt-30 rounded-xl overflow-hidden border border-[0.5px] border-[#FFFFFF33] border-opacity-10">
          <div className="flex items-center justify-center w-[100%] min-w-auto md:w-[35%] md:min-w-[180px] p-8 border-r bg-[#121316CC] backdrop-blur-[1.5px] border-[0.5px] border-[#FFFFFF33] border-opacity-10">
            <h2 className="text-2xl md:text-[30px] font-extrabold text-white leading-tight text-left">
              Technology for<br />profitability
            </h2>
          </div>
          <div className="flex flex-col justify-center w-[100%] lg:w-[65%] py-8 px-15 bg-[#121316CC] backdrop-blur-[1.5px] border border-[0.5px] border-[#FFFFFF33] border-opacity-10">
        ...
        <div className="w-[90%] max-w-[1332px] mx-auto mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-20">
          {/* Card 1 */}
          <div className="flex flex-col items-center p-4 pb-8 bg-[#121316CC] backdrop-blur-[1.5px] border border-[0.5px] border-[#FFFFFF33] border-opacity-10 text-center rounded-[20px]">
            <Image
        ...
        <div className="w-[90%] max-w-[1332px] mx-auto mt-27 border-t border-b border-white/10 px-2 py-6 flex items-center justify-between gap-8 xl:flex-row flex-col xl:border-t xl:border-b border-0">
          <div className="flex items-center min-w-[220px] xl:w-auto xl:justify-start justify-center client-info-row">
            ...
            <div className="flex flex-col items-center ml-4 client-info-text">
              <span className="text-white text-sm font-semibold text-left min-w-[200px] -ml-10 md:-ml-0">★★★★★</span>
