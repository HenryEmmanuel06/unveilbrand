...
const NavBar = () => {
  ...
  if (!mounted) {
    return (
      <nav className="fixed top-[5px] lg:top-[20px] left-0 right-0 z-50 w-[90%] lg:w-[945px] mx-auto flex flex-col justify-between items-center px-[15px] border border-white/10 bg-black/90 lg:bg-black/30 backdrop-blur-[5px] transition-all duration-500 ease-in-out rounded-[30px] lg:rounded-full py-[10px] lg:py-[15px]">
        <div className="w-full flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center">
            <ul className="flex gap-8 text-base font-medium items-center text-white">
              <li className="hover:text-[#A212A8] transition cursor-pointer text-[#A212A8] font-semibold">
                <Link href="/">Home</Link>
              </li>
              ...
              <li className="ml-10">
                <Link href="/contact">
                  <button className="border rounded-full px-6 py-2 font-medium transition cursor-pointer text-white hover:bg-[#A212A8] border-white/30">
                    Contact
                  </button>
                </Link>
              </li>
        ...
        <div className={`transition-all duration-500 ease-in-out lg:hidden w-full overflow-hidden ${isMobileMenuOpen ? 'max-h-100 mt-8' : 'max-h-0'}`}>
          <ul className="flex flex-col items-center gap-8 text-2xl font-medium text-center text-white">
            <li className="hover:text-[#A212A8] transition cursor-pointer">
            ...
            <li className="mt-4 hover:text-[#A212A8] transition cursor-pointer">
              <Link href="/contact" onClick={handleNavigation}>
                <button className="border rounded-full px-8 py-3 font-medium transition cursor-pointer text-white border-white/30 hover:bg-[#A212A8]">
                  Contact
                </button>
              </Link>
            </li>
