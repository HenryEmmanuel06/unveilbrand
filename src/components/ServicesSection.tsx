        ...
        <div className="grid grid-cols-2 gap-6 w-full max-w-5xl mb-10 mx-auto w-[90%] max-w-[1180px]">
          {services.map((service, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`backdrop-blur-[1px] border border-[0.5px] ${theme === 'dark' ? 'bg-[#121316CC] border-[#FFFFFF33] text-white' : 'bg-black/5 border-black/10 text-black'} backdrop-blur-[1px] border-opacity-10 px-8 py-7 md:py-5 text-[14px] md:text-[20px] font-normal flex items-center justify-start shadow-md text-center md:text-left ${borderRadius} transition-colors duration-300`}
                style={{
