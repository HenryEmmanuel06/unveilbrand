      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-5xl mb-10 mx-auto w-[90%] max-w-[1180px]">
        {services.map((service, idx) => {
          ...
          return (
            <div
              key={idx}
              className={`bg-[#FFFFFF0D] px-8 py-5 text-white text-[18px] md:text-[20px] font-normal flex items-center justify-start shadow-md border border-[0.5px] border-[#FFFFFF33] border-opacity-10 backdrop-blur-sm ${borderRadius}`}
              style={{
